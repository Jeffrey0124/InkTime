...
ADMIN_INITIAL_PASSWORD = _str("INKTIME_ADMIN_INITIAL_PASSWORD", "")
SESSION_SECRET = _str("INKTIME_SESSION_SECRET", "")
AUTH_COOKIE_SECURE = _str("INKTIME_AUTH_COOKIE_SECURE", "false").lower() in {
    "1",
    "true",
    "yes",
}
